...
export const PatientFormType = z.object({
	...
	dateOfTest: z.string().nullish().optional(),

	// ARVs
	hasPatientOnARVs: z.boolean(),
	dateStartedARVs: z.string().nullish().optional(),

	// WHO
	whoStage: z.string(),

	hasTreatmentSupport: z.boolean(),
	typeOfSupport: z.string().nullish().optional(),
...
export function createPatientObject<
	Org extends t.Organization = t.Organization
>(from: PatientFormType, createdAt: Date, registeredOrganization: Org) {
